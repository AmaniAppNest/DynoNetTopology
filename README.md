...
Physical/system dynamics — represents the evolving system.
Quantum sensing — models measurement through nitrogen-vacancy (NV) centers.
Dynamic network analysis — converts measurements into time-dependent interaction networks.
Multiscale topology — characterizes structural changes across time and filtration scale.
...
For example, when a feature associated with a first Betti number, β₁, appears at one time and a similar feature appears later, temporal analysis can distinguish between possibilities such as:
...
$$ \beta_0(t,\mathrm{scale}), \qquad \beta_1(t,\mathrm{scale}), \qquad \beta_2(t,\mathrm{scale}) $$
...
<img width="1505" height="812" alt="image" src="https://github.com/user-attachments/assets/d8b87a7f-582b-420a-a834-2207a4de479e" />
...
**This is the version I would put into the GitHub repository.** It uses your **one figure only**; there is no requirement to add the other diagrams as figures.
